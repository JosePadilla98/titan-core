...
featuredImage: '/images/blog/update-categories.jpg'
...
seo:
    ...
    image: '/images/blog/update-categories.jpg'
---
...
```typescript
export const categories = [...existingCategories, { name: 'Marketing', slug: 'marketing', description: 'Marketing tips and tutorials' }];
```
